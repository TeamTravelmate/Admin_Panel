...
void main() {
  runApp(MaterialApp(
    home: CommentsComplaint(),
  ));
}

class CommentsComplaint extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
            icon: Icon(Icons.menu), // Icon to open the drawer
            onPressed: () {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to delete this comment?'), // Customize this message for "Posts"
          actions: <Widget>[
            TextButton(
              child: Text('Yes'),
              onPressed: () {
